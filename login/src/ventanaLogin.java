...
Usuario usuario = new Usuario("Aldo", "Moreira", "202109754");

 public static ventanaLogin getInstacia() {
        if (instancia == null) {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (txt_username.getText().equals(usuario.getNombreUsuario()) & txt_password.getText().equals(usuario.getCarnetUsuario())) {
            JOptionPane.showMessageDialog(null, "Bienvenido al sistema ", "Bienvenido", JOptionPane.INFORMATION_MESSAGE);
            ventanaLogin.getInstacia().setVisible(false);
            ventanaIngreso.getInstacia().setVisible(true);
        }else{
